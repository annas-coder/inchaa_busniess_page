    ...
    return (
        <section className="py-20 bg-white">
            <div className="container mx-auto px-4 md:px-6">
                <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl bg-[#3C49DD] bg-[url('/assets/smarter-bg.png')] content-center bg-center bg-no-repeat  min-h-[572px]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center p-8 md:p-[55px_64px]">
                        ...
                        <div className="h-full flex items-end justify-center md:items-end md:justify-end z-0 mt-8 md:mt-0 relative md:static">
                            <motion.div
